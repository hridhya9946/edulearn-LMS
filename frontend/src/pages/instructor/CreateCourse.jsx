...
import { Container, Form, Button, Row, Col, Card, ProgressBar, Alert } from 'react-bootstrap';
...
function CreateCourse() {
  ...
  const handleSubmit = async (asDraft = true) => {
    ...
    try {
      await createCourse({ ...courseData, status: asDraft ? 'draft' : 'pending' });
      navigate('/instructor/dashboard');
    } catch (err) {
      console.error('Create course error response:', err.response?.data);
    ...
    <Container className="py-5">
      ...
      <div className="mb-4">
        <div className="d-flex justify-content-between">
          ...
          <span className={step >= 3 ? 'text-primary fw-bold' : 'text-muted'}>3. Review & Submit</span>
        </div>
          ...
          <Card.Body>
            ...
            <div className="d-flex justify-content-between mt-4">
              ...
              <div>
                ...
                <Button variant="success" onClick={() => handleSubmit(false)} disabled={loading}>
